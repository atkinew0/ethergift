...
const FAQ = () => {
    ...
    return(
        ...
        <dl>
            ...
            <dd>Ethergift lets you send Ether as a gift to anyone with an existing Ethereum address via a smart contract. Our website gives you a personalized card to print out or email to the recipient.</dd>
            <hr/>
